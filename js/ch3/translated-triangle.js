var main = function () {
  ...
  webgl.vertShaderPath  = "glsl/ch3/translated-triangle.vsh";
  webgl.fragShaderPath  = "glsl/ch3/hello-triangle.fsh";
  webgl.attrNames       = ["Position"];
  webgl.uniNames        = ["Translation"];
  ...
  webgl.script = function(gl) {
    ...
    var translations = [0.5, 0.5, 0.0, 0.0]
    gl.uniform4fv(gl.uni.Translation, translations);
